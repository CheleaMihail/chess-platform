...
const Clubs = () => {
  return (
    <div>
      ...
      deleniti, quia voluptatem nesciunt cumque cum laudantium. Voluptatibus
      temporibus natus aliquid sint illum. Quibusdam, non iusto suscipit
      explicabo vero repudiandae maiores eos aperiam quasi vel, aspernatur
      voluptas ipsa recusandae dolorum molestias quas eius tempora iste soluta
      doloribus velit accusamus magnam! Veritatis consectetur error molestias
