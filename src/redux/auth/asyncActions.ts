...
export const fetchAuthRefresh = createAsyncThunk<number, undefined, { rejectValue: IError }>(
  'auth/fetchAuthRefresh',
  async (undefined, { rejectWithValue }) => {
    try {
      const refreshToken = localStorage.getItem('refreshToken');
      const response = await axios.post<IRefreshResponse>(apiUrl + 'auth/refresh/', {
